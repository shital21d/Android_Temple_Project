                ...
                client.post(Config.verify, params, new JsonHttpResponseHandler() {
                            ...
                            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                                ...
                                try {
                                    ...
                                    if (success.equals("1")) {
                                        Toast.makeText(Donate2.this, "Payment Done", Toast.LENGTH_SHORT).show();

                                        Intent i = new Intent(Donate2.this, HomePage2.class);
                                        startActivity(i);
                                        finish();
                                    } else {
                                        Toast.makeText(Donate2.this, "Server Error", Toast.LENGTH_SHORT).show();
                                    }
                            ...
                            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                                ...
                                Toast.makeText(Donate2.this, "Could not connect", Toast.LENGTH_SHORT).show();
                            }
                        }
                );
            }
